  ...
  return (
    <>
      <PageHeader
        ...
        eyebrow="Detail Tarkam" title="Informasi lengkap untuk turnamen Tarkam ini" description="Lihat detail jadwal, roster, sesi, timeline, pertandingan, dan streaming untuk Tarkam ini."
      />
