...
export const ProfileDropdown = () => {
  ...
  return (
    <div className="user-profile-dropdown">
      ...
      <div className="profile-image"><img src={memberProfile.picture_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(memberProfile.nickname)}&color=FCFCFC&background=0c0c35`} alt={memberProfile.nickname} /></div>
